...
export default function About() {
  return (
    <div className="flex flex-col pt-5">
      <h1 className="text-5xl font-bold bg-gradient-to-r from-[#80ffea] to-[#d49ef5] bg-clip-text text-transparent mb-10 text-center">Sobre mim</h1>
      ...
      <div className="flex flex-col items-center md:flex-row gap-14">
        ...
        <div>
          <Image 
            ...
            width={300} 
            height={300} 
            className="rounded-lg w-max md:w-80"
            priority
            quality={100}
            />
        </div>
